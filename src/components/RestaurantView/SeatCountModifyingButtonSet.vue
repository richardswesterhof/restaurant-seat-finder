<template>
  <div>
    ...
    <div class="is-hidden-tablet has-text-centered">
      ...
      <template  v-if="isPos()">
        <b-button type="is-primary" class="is-large" @click="modifySeats(1)" style="margin: 0 0.5% 0.5vh 0.5%;">{{getSimpleSign()}}</b-button>
        <br>
      </template>
      ...
      <template v-if="!isPos()">
        <br>
        <b-button type="is-primary" class="is-large" @click="modifySeats(1)" style="margin: 0.5vh 0.5% 0 0.5vh;">{{getSimpleSign()}}</b-button>
      </template>
